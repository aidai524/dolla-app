...
export default function useToast() {
  const success = (params: any) => {
    return toast(
      <Toast type="success" duration={ToastAutoCloseDuration} {...params} />,
      {
        position: "top-right",
  ...
  const fail = (params: any) => {
    return toast(
      <Toast type="error" duration={ToastAutoCloseDuration} {...params} />,
      {
        position: "top-right",
        autoClose: ToastAutoCloseDuration
      }
  ...
  const info = (params: any) => {
    return toast(
      <Toast type="info" duration={ToastAutoCloseDuration} {...params} />,
      {
        position: "top-right",
        autoClose: ToastAutoCloseDuration
      }
  ...
  const loading = (params: any) => {
    return toast(
      <Toast type="pending" duration={ToastAutoCloseDuration} {...params} />,
      {
        position: "top-right",
        autoClose: ToastAutoCloseDuration
      }
