...
export default function Progress({ progress }: { progress: number }) {
  return (
    <div className="mt-[4px] w-[365px] h-[12px] rounded-[30px] bg-[#0F1218] border border-[#3C3420]">
      <div
        className="h-full rounded-[10px] bg-linear-to-r from-[#FFF9B8] to-[#99956E] p-[1px]"
        style={{
          width: `${Math.min(progress, 100)}%`
        }}
      >
        <div className="h-full rounded-[10px] bg-[#FFEA00] relative">
...
const Label = () => {
  return (
    <div className="absolute top-[10px] right-[-45px] w-[90px] h-[42px]">
      <span
        className="absolute top-[16px] left-[0px] w-full z-[2] text-[#FFEF43] text-center  font-['DelaGothicOne'] text-[14px]  leading-[14px] rotate-[-5deg]"
        style={{
